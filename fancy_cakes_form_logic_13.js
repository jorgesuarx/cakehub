...
function setDateTime() {
  ...
  datetimeInput.addEventListener('change', function() {
    ...
    if (!dateIsValid) {
      dateErrorMessage = showErrorMessage(dateErrorMessage, `Date not available. Earliest available date is ${formatDate(twoDaysFromNow)}. For rush orders, call us at <a href="tel:+18632688441">(863) 268-8441</a>.`);
