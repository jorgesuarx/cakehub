...
document.addEventListener("DOMContentLoaded", function() {
  ...
  var sections = ["cakepops", "cupcakes", "cakesicles", "cake-jars", "pastries",  "desserts", "cookies", "tres-leches-shoots", "traditional-tres-leches", "chocolate-dipped-treats", "custom-cake"];
