...
document.addEventListener("DOMContentLoaded", function() {
  ...
  var sections = ["cakepops", "cupcakes", "cakesicles", "cake-jars", "desserts",  "pastries", "cookies",  "traditional-tres-leches", "tres-leches-shoots", "chocolate-dipped-treats", "custom-cake"];
