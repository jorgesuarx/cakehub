...
function setDateTime() {
  ...
  datetimeInput.addEventListener('change', function() {
    ...
    if (!dateIsValid) {
      dateErrorMessage = showErrorMessage(dateErrorMessage, `Not available. Next available date is ${formatDate(twoDaysFromNow)}. For rush orders, call us at (863) 268-8441.`);
